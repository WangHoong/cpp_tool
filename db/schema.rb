...
ActiveRecord::Schema.define(version: 20170613033907) do
  ...
  create_table "artist_albums", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4" do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["album_id", "artist_id", "album_type"], name: "index_artist_albums_on_album_id_and_artist_id_and_album_type", using: :btree
  end
  ...
  create_table "resources", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4" do |t|
    ...
    t.index ["position"], name: "index_resources_on_position", using: :btree
  end
