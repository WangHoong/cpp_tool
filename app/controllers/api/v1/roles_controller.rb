class Api::V1::RolesController < Api::V1::BaseController
  ...
  def permissions
    ...
    @groups.each do |group|
       groups << {id: group.id,name: group.name,subclass: group.subclass.map{|m| Hash[{id: m.id,name: m.name,permissions: m.permissions.map{|n| Hash[{id: n.id,display_name: n.display_name,name: n.name}]}}]}}
    end
